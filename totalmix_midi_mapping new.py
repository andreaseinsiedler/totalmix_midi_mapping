...
def reset_banking():
    ...
    while True:
        ...
        if bank_dn:
            midiout.send_message([0x80, output_CC_dict("Bnk_dn"), 0])
            bank_dn = False
                        ...
                        for key, value in routing_dict.items():
                            ...
                            if value:
                                ...
                                if value == "TlkB":
                                    ...
                                    totalmix_row = banking_index_dict[key]
                                    totalmix_bank = int(output_bank_dict[totalmix_row])
